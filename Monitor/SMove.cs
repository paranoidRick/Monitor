...
public class SMove : MetroForm
{
	...
	private void InitChart()
	{
		...
		series.YValueMembers = "move_small";
	...
	public DataSet DisplaySData(int userId)
	{
		...
		string sql = "SELECT result_data.time,  result_data.move_small FROM result_data WHERE  result_data.time >=  '" + time + "'AND result_data.user_id ='" + tools.GetLoginUserId() + "' ORDER BY result_data.id DESC LIMIT 10000";
